-- This code utilizes INSERT ON CONFLICT on customer_car_target table like this:
...
ON CONFLICT (CUSTOMER_ID) DO update
    SET CLIENT_REPORTING_DATE    = excluded.CLIENT_REPORTING_DATE,
        CLIENT_AGE               = excluded.CLIENT_AGE,
        CLIENT_EDUCATION         = excluded.CLIENT_EDUCATION,
        CLIENT_BUCKET            = excluded.CLIENT_BUCKET,
        HOUSEHOLD_ID             = excluded.HOUSEHOLD_ID,
        HOUSEHOLD_INCOME_ID      = excluded.HOUSEHOLD_INCOME_ID,
        HOUSEHOLD_REPORTING_DATE = excluded.HOUSEHOLD_REPORTING_DATE,
        HOUSEHOLD_MARRIED        = excluded.HOUSEHOLD_MARRIED,
        HOUSEHOLD_HOUSE_OWNER    = excluded.HOUSEHOLD_HOUSE_OWNER,
        HOUSEHOLD_CHILD_NO       = excluded.HOUSEHOLD_CHILD_NO,
        HOUSEHOLD_HH_MEMBERS     = excluded.HOUSEHOLD_HH_MEMBERS,
        HOUSEHOLD_BUCKET         = excluded.HOUSEHOLD_BUCKET,
        LOAN_ID                  = excluded.LOAN_ID,
        LOAN_REPORTING_DATE      = excluded.LOAN_REPORTING_DATE,
        LOAN_INTODEFAULT         = excluded.LOAN_INTODEFAULT,
        LOAN_INSTALLMENT_NM      = excluded.LOAN_INSTALLMENT_NM,
        LOAN_AMT                 = excluded.LOAN_AMT,
        LOAN_INSTALLMENT_AMT     = excluded.LOAN_INSTALLMENT_AMT,
        LOAN_PAST_DUE_AMT        = excluded.LOAN_PAST_DUE_AMT,
        LOAN_BUCKET              = excluded.LOAN_BUCKET,
        INCOME_ID                = excluded.INCOME_ID,
        INCOME_REPORTING_DATE    = excluded.INCOME_REPORTING_DATE,
        INCOME_FIRST_JOB         = excluded.INCOME_FIRST_JOB,
        INCOME_AMOUNT            = excluded.INCOME_AMOUNT,
        INCOME_BUCKET            = excluded.INCOME_BUCKET
WHERE excluded.CLIENT_REPORTING_DATE > CLIENT_REPORTING_DATE
   OR excluded.HOUSEHOLD_REPORTING_DATE > HOUSEHOLD_REPORTING_DATE
   OR excluded.LOAN_REPORTING_DATE > LOAN_REPORTING_DATE
   OR excluded.INCOME_REPORTING_DATE > INCOME_REPORTING_DATE
;



-- Version 1 - took 6 minutes to finish
...
--          LEFT JOIN income as i on l.CUSTOMER_ID = i.CUSTOMER_ID
--          LEFT JOIN household as h on i.INCOME_ID = h.INCOME_ID
-- ON CONFLICT (CUSTOMER_ID) DO UPDATE SET
-- -- Client attributes
-- CLIENT_REPORTING_DATE    = EXCLUDED.CLIENT_REPORTING_DATE,
-- CLIENT_AGE               = EXCLUDED.CLIENT_AGE,
-- CLIENT_EDUCATION         = EXCLUDED.CLIENT_EDUCATION,
-- CLIENT_BUCKET            = EXCLUDED.CLIENT_BUCKET,
--
...
-- INCOME_BUCKET            = EXCLUDED.INCOME_BUCKET
-- WHERE 1 = 1
--    OR excluded.CLIENT_REPORTING_DATE > customer_car.CLIENT_REPORTING_DATE
--    OR excluded.HOUSEHOLD_REPORTING_DATE > customer_car.HOUSEHOLD_REPORTING_DATE
--    OR excluded.LOAN_REPORTING_DATE > customer_car.LOAN_REPORTING_DATE
--    OR excluded.INCOME_REPORTING_DATE > customer_car.INCOME_REPORTING_DATE
-- ;
